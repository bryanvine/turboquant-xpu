...
# ---------------------------------------------------------------------------
from vllm.v1.attention.ops.triton_turboquant_stage2 import (
    _fwd_kernel_stage2,
)
...
def triton_turboquant_decode_attention(
    ...
    # Tunable via env vars for XPU optimization experiments
    import os as _os
    BLOCK_KV = int(_os.environ.get("TQ_BLOCK_KV", "4"))
    _STAGE1_NUM_WARPS = int(_os.environ.get("TQ_STAGE1_NUM_WARPS", "1"))
